...
const POSTS: MissionPost[] = [
  ...
  // ════════════════════════════════════════════
  {
    ...
    choices: [
      ...
      '🏛️ Authority — trusting the influencer as an expert',
  ...
  // ════════════════════════════════════════════
  {
    ...
    choices: [
      '⚖️ Balanced reporting of both sides of immigration debate',
      '⚔️ Dehumanization through war metaphors and out-group labeling',
  ...
  // ════════════════════════════════════════════
  {
    ...
    choices: [
      ...
      '❤️ Care/harm (compassion for vulnerable children)',
  ...
  // ════════════════════════════════════════════
  {
    ...
    choices: [
      ...
      '⚔️ The myth that you must sacrifice freedom for safety — they are presented as opposites',
      '🛡️ The myth that government surveillance is always effective',
      '🕵️ The myth that privacy is no longer possible in the modern world',
    ],
    correctIndex: 1,
