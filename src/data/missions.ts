...
const POSTS: MissionPost[] = [
  {
    ...
    isManipulative: true,
    explanation: 'Schopenhauer: false authority ("Institute", "Dr.") + Cialdini: Authority. "80%" with no source — false precision. Credibility is faked.',
  ...
  },
  {
    ...
    question: 'Is this post manipulating you?',
    isManipulative: true,
    explanation: 'Cialdini: Contrast — "45,000" (huge number) vs "record profits" (unfair). "Interesting" manipulates your interpretation. Outrage instead of analysis.',
  ...
  },
  {
    ...
    question: 'Is this post manipulating you?',
    isManipulative: true,
    explanation: 'Barthes: Myth of "Freedom" — an empty signifier. "Freedom must be limited to be saved" is a classic oxymoron disguised as deep wisdom.',
  ...
  },
  {
    ...
    explanation: 'No emotional manipulation. Facts are verifiable, no hidden agenda. Real news without rhetorical tricks.',
    neededTool: 'feelings-check',
  ...
  },
  {
    ...
    question: 'Is this post manipulating you?',
    isManipulative: true,
    explanation: 'Tajfel & Turner: Social Identity Theory — pure us/them construction with zero data. "They" are homogenized, no evidence.',
  ...
  },
  {
    ...
    question: 'Is this post manipulating you?',
    isManipulative: true,
    explanation: 'Haidt: Care + Authority buttons. "Who would oppose protecting children?" — false binary (Kahneman). Emotion over argument.',
  ...
  },
  {
    ...
    question: 'Is this post manipulating you?',
    isManipulative: false,
    explanation: 'No agenda. Satirical tone but facts are correct. No emotional triggers, no hidden message.',
